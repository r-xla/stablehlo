...
# 2D convolution with asymmetric (causal) padding

    Code
      repr(f)
    Output
      [1] "func.func @main (%lhs: tensor<1x3x3x1xf32>, %rhs: tensor<2x2x1x1xf32>) -> tensor<1x3x4x1xf32> {\n%0 = \"stablehlo.convolution\"(%lhs, %rhs) {\nwindow_strides = array<i64: 1, 1>,\npadding = dense<[[1, 0], [2, 0]]> : tensor<2x2xi64>,\nlhs_dilation = array<i64: 1, 1>,\nrhs_dilation = array<i64: 1, 1>,\nwindow_reversal = array<i1: false, false>,\nfeature_group_count = 1 : i64,\nbatch_group_count = 1 : i64,\ndimension_numbers = #stablehlo.conv<[b, 0, 1, f]x[0, 1, i, o]->[b, 0, 1, f]>,\nprecision_config = [#stablehlo<precision DEFAULT>, #stablehlo<precision DEFAULT>]\n}: (tensor<1x3x3x1xf32>, tensor<2x2x1x1xf32>) -> (tensor<1x3x4x1xf32>)\nreturn %0 : tensor<1x3x4x1xf32>\n}\n"
