...
The {stablehlo} R package provides a functional API to create [stableHLO](https://github.com/openxla/stablehlo) programs.
...
To create a function that takes `x` and `y` as arguments and adds them, we can pass the two variables to the `hlo_add()` function:
...
The central class that underpins the API is the `FuncVariable` class.
...
The definitions of the primitive stableHLO operators can be found [here](https://openxla.org/stablehlo/spec#ops).
