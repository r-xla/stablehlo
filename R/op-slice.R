...
infer_types_slice <- function(
  ...
  assert_const(start_indices, dtype = as_dtype("i64"), naxes = 1L)
  assert_const(limit_indices, dtype = as_dtype("i64"), naxes = 1L)
  assert_const(strides, dtype = as_dtype("i64"), naxes = 1L)
