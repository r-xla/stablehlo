...
The {stablehlo} package represents StableHLO programs as nested S7 objects.
When working with the package, you usually don't construct these objects via their `S7`-constructor, but through the more user-friendly `hlo_<name>` functions.
