...
- [`index_out_of_bounds_error()`](index_out_of_bounds_error.md) : Index
  Out of Bounds Error
...
- [`permutation_error()`](permutation_error.md) : Permutation Error
...
- [`shape_mismatch_error()`](shape_mismatch_error.md) : Shape Mismatch
  Error
- [`slice_index_error()`](slice_index_error.md) : Slice Index Error
- [`tensor_dtype_error()`](tensor_dtype_error.md) : Tensor Data Type
  Error
- [`tensor_ndims_error()`](tensor_ndims_error.md) : Tensor Number of
  Dimensions Error
