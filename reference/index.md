...
- [`GatherDimensionNumbers()`](GatherDimensionNumbers.md) :
...
- [`ScatterDimensionNumbers()`](ScatterDimensionNumbers.md) :
...
- [`.current_func()`](dot-current_func.md) : Get the last function
  created
- [`error_concatenate_shapes()`](error_concatenate_shapes.md) :
  ErrorConcatenateShapes
- [`error_dim_size_mismatch()`](error_dim_size_mismatch.md) :
  ErrorDimSizeMismatch
- [`error_dimension_uniqueness()`](error_dimension_uniqueness.md) :
  ErrorDimensionUniqueness
- [`error_index_in_set()`](error_index_in_set.md) : ErrorIndexInSet
- [`error_index_out_of_bounds()`](error_index_out_of_bounds.md) :
  ErrorIndexOutOfBounds
- [`error_indices_not_sorted()`](error_indices_not_sorted.md) :
...
- [`error_unexpected_list_type()`](error_unexpected_list_type.md) :
...
- [`hlo_func()`](hlo_func.md) [`local_func()`](hlo_func.md) : Create a
  function
- [`infer_types_gather()`](hlo_gather.md)
  [`hlo_gather()`](hlo_gather.md) : Gather Operator
...
- [`infer_types_rsqrt()`](hlo_rsqrt.md) [`hlo_rsqrt()`](hlo_rsqrt.md) :
  Rsqrt Operator
- [`infer_types_scatter()`](hlo_scatter.md)
  [`hlo_scatter()`](hlo_scatter.md) : Scatter Operator
