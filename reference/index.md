...
- [`.current_func()`](dot-current_func.md) : Get the last function
  created
- [`error_class()`](error_class.md) : Class Error
...
- [`error_index_out_of_bounds()`](error_index_out_of_bounds.md) : Index
  Out of Bounds Error
- [`error_invalid_identifier()`](error_invalid_identifier.md) : Invalid
  Identifier Error
- [`error_permutation()`](error_permutation.md) : Permutation Error
- [`error_shape_mismatch()`](error_shape_mismatch.md) : Shape Mismatch
  Error
- [`error_slice_index()`](error_slice_index.md) : Slice Index Error
- [`error_tensor_dtype()`](error_tensor_dtype.md) : Tensor Data Type
  Error
- [`error_tensor_ndims()`](error_tensor_ndims.md) : Tensor Number of
  Dimensions Error
- [`error_tensor_shape()`](error_tensor_shape.md) : Tensor Shape Error
- [`error_unequal_tensor_types()`](error_unequal_tensor_types.md) :
