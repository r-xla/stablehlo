...
- [`hlo_scalar()`](hlo_constant.md) [`hlo_tensor()`](hlo_constant.md)
  [`hlo_empty()`](hlo_constant.md) : Create a Constant
...
- [`hlo_slice()`](hlo_slice.md) : Slice Operator
- [`hlo_sort()`](hlo_sort.md) : Sort Operator
...
- [`hlo_while()`](hlo_while.md) : While Operator
- [`hlo_xor()`](hlo_xor.md) : Xor Operator
- [`infer_types_boolean_biv()`](infer_types_boolean_biv.md) : Infer
  types for boolean binary operations
- [`infer_types_boolean_uni()`](infer_types_boolean_uni.md) : Infer
  types for boolean unary operations
