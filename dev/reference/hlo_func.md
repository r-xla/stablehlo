...
[`Func`](https://r-xla.github.io/stablehlo/dev/reference/Func.md) with
the given id which is afterwards accessible via
[`.current_func()`](https://r-xla.github.io/stablehlo/dev/reference/dot-current_func.md).
Functions receiving a
[`Func`](https://r-xla.github.io/stablehlo/dev/reference/Func.md) as an
argument (such as
...
which will *not* be accessible this way.
...
- envir:
  ...
  [`Func`](https://r-xla.github.io/stablehlo/dev/reference/Func.md) if
  it was not returned yet.
